...
feature:
  ...
  feature_item:
    ...
    - name : "GAZ"
      icon : "fas fa-fire"
      content : "
      Le diagnostic gaz consiste à vérifier les installations intérieures de gaz afin de repérer d’éventuels défauts pouvant mettre en danger la sécurité des personnes et leurs biens. Il est réalisé sans démontage des installations et doit être conforme à une méthodologie strictement réglementée .
